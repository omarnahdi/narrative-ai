...
# Streamlit App
st.set_page_config(page_title="Post Generation Agent Team", page_icon="🧠")
st.title("💬Meet Linkedin Post Gen Agentic Team(Narrative AI)")
st.write("🚀 Powered by Gemini, Agno, Jina, Pydantic, etc")
...
if prompt := st.chat_input("Wanna create a Post? Go ahead!"):
    ...
    with st.spinner("Narrative AI is thinking..."):
        reply = PostGenTeam.run(prompt).content
